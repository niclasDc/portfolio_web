...
function About(){
    return(
      <div style={{background: "#F8F6F5"}}>
              ...
              <div className="row row-content">
                  ...
                  <div className="col-12 col-md-5" style={{fontSize: "16px"}}>
                      ...
                      <p>
                          ...
                          <br/>
                          <br/>
                          Desde 2016, empecé mi desarrollo como programador con un tecnólogo en Sistemas de la Computación,
          ...
          <div className="row">
              <div className="row-content-about col-12 d-flex justify-content-center text-white"  style={{backgroundColor: "#D47C42"}}>
